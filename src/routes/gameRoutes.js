...
import { updateWinner, undoGame, triggerEspnPoll, releaseGameHold } from "../controllers/gameController.js";
...
router.post("/admin/trigger-espn-poll", requireSiteAdmin, verifyCsrf, triggerEspnPoll);
